...
class Main {
  ...
  public Main() {
    ...
    addBackground(branchGroup, "../00-resources/stars.jpg");
  ...
  private BranchGroup createBranchGroup() {
    ...
    tg.addChild(new Planet(1.0f, 0.0f, "../00-resources/earth.jpg", this.defaultBound)); // <-- NOTE: edit here with other components. ***
    // add tg to bg
    bg.addChild(tg);
    // return bg
    return bg;
